...
while True:
            ...
            if brutx == "":
                ...
                while True:
                    ...
                    if passd == "":
                        ...
                        passlist = '/data/data/com.termux/Devil/config/password/pass.txt'
                        print()
                        hackmail()
                        break
        ...
        ####################### MD5 hash cracking #########################
                ...
                while True:
                    ...
                    if lisw == '':
                        ...
                        print()
                        wordlist = '/data/data/com.termux/Devil/config/wordlist/wordlist.txt'
                        print()
                        mds()
                        print()
                        input("\033[1;94mPress ENTER To Continue")
    ...
    ######################### Hacking Tools installer section ###########################
        ...
        while True:
            ...
            print(banner)
            print()
            print("\033[1;91m[*] \033[1;97mThanks for using my tool '\033[1;91mDevil\033[1;97m'. So you can follow me on various social media site. Link and options are given down below, So select here options where you want to follow me ")
            print()
            fol = input(soc)
            if fol == '1' or fol == '01':
                print()
